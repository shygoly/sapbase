...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([Organization, OrganizationMember, Invitation, OrganizationActivity, BrandConfig, User]),
    JwtModule.register({}),
    ConfigModule,
    StorageModule,
  ],
  controllers: [OrganizationsController, InvitationsController, InvitationsPublicController, SubscriptionsController, BrandConfigController],
