...
import { Plus, Mail, UserPlus, Trash2, Crown, User } from 'lucide-react'
...
export default function OrganizationsPage() {
  const { currentOrganization, organizations, loadOrganizations, createOrganization } =
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      ...
      <AlertDialog
        ...
        onOpenChange={(open) => setDeleteMemberDialog({ open, member: deleteMemberDialog.member })}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
