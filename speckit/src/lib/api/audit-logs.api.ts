...
export const auditLogsApi = {
  ...
  async findAll(
    ...
    console.log('Audit logs API raw response:', responseData)
    ...
    if (responseData.pagination) {
      ...
      console.log('Parsed audit logs result:', result)
      return result
    }
    ...
    // Last fallback
    console.warn('Unexpected audit logs response format:', responseData)
    return {
      data: [],
      total: 0,
      page,
